...
{
public:
    WorldModel(std::shared_ptr<Matrix<std::shared_ptr<WorldTile>>> tiles, std::shared_ptr<Protagonist> protagonist);
    ...
    std::shared_ptr<Matrix<std::shared_ptr<WorldTile>>> tiles() const { return _tiles; }
    std::vector<std::shared_ptr<WorldTile>> getEnemyTiles();
    std::vector<std::shared_ptr<WorldTile>> getHealtPackTiles();
private:
    std::shared_ptr<Matrix<std::shared_ptr<WorldTile>>> _tiles;
